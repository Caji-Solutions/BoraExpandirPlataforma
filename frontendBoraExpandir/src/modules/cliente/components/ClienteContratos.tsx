...
import { FileCheck, FileText, Loader2, XCircle } from 'lucide-react'
    ...
    <div className="space-y-4">
      {contratos.length === 0 ? (
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-100 dark:border-neutral-800 shadow-sm p-12 text-center">
          <p className="text-sm text-gray-500">Nenhum contrato disponível.</p>
        </div>
      ) : (
          ...
          <div key={contrato.id} className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-2xl p-5 space-y-4">
            ...
            <div className="space-y-2">
              ...
              {contrato.assinatura_status === 'em_analise' && (
                <p className="text-xs text-gray-500">Contrato em análise pelo comercial.</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {(contrato.pagamento_status === 'pendente' || contrato.pagamento_status === 'recusado') && contrato.assinatura_status === 'aprovado' && (
                <input
                  type="file"
                  accept="application/pdf,image/*"
                  onChange={(e) => {
              ...
              {contrato.pagamento_status === 'em_analise' && (
                <p className="text-xs text-gray-500">Comprovante em análise pelo financeiro.</p>
              )}
