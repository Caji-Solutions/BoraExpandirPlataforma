...
comercial.get('/processos', ComercialController.getAllProcessos.bind(ComercialController))
comercial.get('/requerimentos', ComercialController.getAllRequerimentos.bind(ComercialController))
